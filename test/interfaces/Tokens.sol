...
library Ethereum {
    ...
    IUniversalRouter public constant UNIVERSAL_ROUTER =
        IUniversalRouter(payable(0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD));
...
library BSC {
    ...
    IUniversalRouter public constant UNIVERSAL_ROUTER =
        IUniversalRouter(payable(0x4Dae2f939ACf50408e13d58534Ff8c2776d45265));
...
library Arbitrum {
    ...
    IUniswapV3Factory public constant UNISWAP_V3_FACTORY = IUniswapV3Factory(0x1F98431c8aD98523631AE4a59f267346ea31F984);
    IUniversalRouter public constant UNIVERSAL_ROUTER =
        IUniversalRouter(payable(0x5E325eDA8064b456f4781070C0738d849c824258));
    IUniswapV2Router public constant UNISWAP_V2_ROUTER = IUniswapV2Router(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
...
library Blast {
    ...
    IUniswapV2Router public constant UNISWAP_V2_ROUTER = IUniswapV2Router(0xBB66Eb1c5e875933D44DAe661dbD80e5D9B03035);
...
library Polygon {
    ...
    IUniswapV3Factory public constant UNISWAP_V3_FACTORY = IUniswapV3Factory(0x1F98431c8aD98523631AE4a59f267346ea31F984);
    IUniversalRouter public constant UNIVERSAL_ROUTER =
        IUniversalRouter(payable(0xec7BE89e9d109e7e3Fec59c222CF297125FEFda2));
    IUniswapV2Factory public constant UNISWAP_V2_FACTORY = IUniswapV2Factory(0x9e5A52f57b3038F1B8EeE45F28b3C1967e22799C);
    IUniswapV2Router public constant UNISWAP_V2_ROUTER = IUniswapV2Router(0xedf6066a2b290C185783862C7F4776A2C8077AD1);
...
library Optimism {
    ...
    IUniswapV3Factory public constant UNISWAP_V3_FACTORY = IUniswapV3Factory(0x1F98431c8aD98523631AE4a59f267346ea31F984);
    IUniversalRouter public constant UNIVERSAL_ROUTER =
        IUniversalRouter(payable(0xCb1355ff08Ab38bBCE60111F1bb2B784bE25D7e8));
    IUniswapV2Factory public constant UNISWAP_V2_FACTORY = IUniswapV2Factory(0x0c3c1c532F1e39EdF36BE9Fe0bE1410313E074Bf);
    IUniswapV2Router public constant UNISWAP_V2_ROUTER = IUniswapV2Router(0x4A7b5Da61326A6379179b40d00F57E5bbDC962c2);
    // Tokens
...
library Celo {
    ...
    IUniversalRouter public constant UNIVERSAL_ROUTER =
        IUniversalRouter(payable(0x643770E279d5D0733F21d6DC03A8efbABf3255B4));
    // Tokens
